...
<div class="main-content">
	...
	<div id="pb-right-column">
		...
		{if $have_image}
			<div id="fb-like">
				<div class="fb-like" data-href="www.kiwi99.com" data-send="false" data-layout="button_count" data-width="200" data-show-faces="true"></div>
			{literal}
				<script type="text/javascript">
	...
	<div id="more_info_block">
		<ul id="more_info_tabs" class="idTabs idTabsShort">
			<li><a hreff="#idTab1">Chi tiết</a></li>
                        ...
                        <li>   
                            ...
                            <span class="last-item">
                                ...
                                {if $packItems|@count > 0}
                                    <h4 style="clear:both; text-align:right; padding: 2px 0px 4px 0px">{l s='Tặng kèm: '}</h4>
            ...
            <div class="header-title">
                <ul>
                    <li class="first">
                       ...
                       <strong> <a href="#">Miễn phí giao hàng</a></strong>
                    </li>
                    <li>
                      
                      <strong>  <a href="#">Chăm sóc khách hàng</a></strong>
                    
                    </li>
                    <li>
                  
                  <strong>      <a href="#">Quy định đổi / Trả hàng</a></strong>
                    </li>
                </ul>
            </div>
