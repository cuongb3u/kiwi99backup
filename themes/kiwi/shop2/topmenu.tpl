...
<ul class="main-menu">
	{foreach from=$blockCategTree.children item=child name=blockCategTree}
		...
		{/foreach}
		<li>
	 <h3><a id_cat="" href="http://kiwi99.com/en/88-san-pham-moi?search_query=new1prod2arrivals&shop=2"title="">Sản phẩm mới</a></h3>
	 </li>
	 	<li>
	 <h3><a id_cat="" href=""title="">Ưa thích nhất</a></h3>
	 </li>
		<li>
	 <h3><a  id_cat="" href="http://kiwi99.com/en/88-san-pham-moi?search_query=prices1drop2specials&shop=2"title=""
	>Ưu đãi</a></h3>
	 </li>
