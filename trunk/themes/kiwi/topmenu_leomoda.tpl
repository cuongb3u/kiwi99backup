...
<ul class="main-menu">
	{foreach from=$blockCategTree.children item=child name=blockCategTree}
			{if $smarty.foreach.blockCategTree.last}
				{include file="$tpl_dir./menu-dropdown.tpl" node=$child last='true'}
			{else}
				{include file="$tpl_dir./menu-dropdown.tpl" node=$child last='false'}
			{/if}
		{/foreach}
</ul>
{*
<ul>
    <li class="current">
        <h3><a href="2-thoi-trang-nu" onmouseover="mopen('m1')" onmouseout="mclosetime()">thời trang nữ leomoda</a></h3>
        <div id="m1" onmouseover="mcancelclosetime()" onmouseout="mclosetime()" class="menu-extend women">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td colspan="3" class="bottom">
                        <h4><span class="menu-ext-women">thời trang nữ moda</span></h4>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <li>
        <h3><a href="#" onmouseover="mopen('m2')" onmouseout="mclosetime()">for teen</a></h3>
        <div id="m2" onmouseover="mcancelclosetime()" onmouseout="mclosetime()" class="menu-extend men">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td colspan="3" class="bottom">
    ...
    <li>
        <h3><a href="#" onmouseover="mopen('m3')" onmouseout="mclosetime()">mẹ & bé</a></h3>
        <div id="m3" onmouseover="mcancelclosetime()" onmouseout="mclosetime()" class="menu-extend children">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td colspan="3" class="bottom">
    ...
    <li>
        <h3><a href="#" onmouseover="mopen('m4')" onmouseout="mclosetime()">thời trang nam</a></h3>
        <div id="m4" onmouseover="mcancelclosetime()" onmouseout="mclosetime()" class="menu-extend children">
        	<table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td colspan="3" class="bottom">
    ...
    <li>
        <h3><a href="#" onmouseover="mopen('m5')" onmouseout="mclosetime()">mắt kính</a></h3>
        <div id="m5" onmouseover="mcancelclosetime()" onmouseout="mclosetime()" class="menu-extend">&nbsp;
        </div>
    </li>
    <li>
        <h3><a href="#" onmouseover="mopen('m5')" onmouseout="mclosetime()">thắt lưng</a></h3>
        <div id="m6" onmouseover="mcancelclosetime()" onmouseout="mclosetime()" class="menu-extend">&nbsp;
        </div>
    </li>
